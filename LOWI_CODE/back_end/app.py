...
MODEL_PATH = 'D:/EJIE SCHOOLING/CLASSES/5th year/Thesis/Scanseta_Collab/Scanseta/LOWI_CODE/back_end/model/121824EXPE4best_model.keras'
'''
ENCODER_PATH = 'D:/EJIE SCHOOLING/CLASSES/5th year/Thesis/Scanseta_Collab/Scanseta/LOWI_CODE/back_end/model/121824EXPE4Label.pkl'
'''
ENCODER_PATH = 'D:/EJIE SCHOOLING/CLASSES/5th year/Thesis/Scanseta_Collab/Scanseta/LOWI_CODE/back_end/model/121824EXPE4Label.pkl'
label_classes = np.load(ENCODER_PATH, allow_pickle=True)  # Load the classes with allow_pickle=True
...
def scan_image():
    ...
    if file:
        ...
        try:
            ...
            predicted_class_id = np.argmax(class_pred)
            predicted_class_label = label_classes[predicted_class_id]  # Use the loaded classes
            ...
            # Check if confidence is less than 0.60 and handle accordingly
            if confidence < 0.75:
                print("No medicine found")
                return jsonify({'message': 'No medicine found'}), 404  # HTTP 404 for not found

            # Draw the bounding box on the image
            image = cv2.rectangle(image, (int(xmin), int(ymin)), (int(xmax), int(ymax)), (0, 255, 0), 8)
            ...
            response = {
                ...
                'image': img_base64  # Include the image with bounding box
            }
